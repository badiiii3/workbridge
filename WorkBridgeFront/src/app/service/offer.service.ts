...
export class OfferService {
  ...
  public addOffer(UserId: String,offer: FormData){
    return this.httpClient.post<Offer>(`http://localhost:9090/addNewOffer/${UserId}`, offer);
  }
  ...
  public getOfferByUser(userId: string): Observable<Offer[]> {
